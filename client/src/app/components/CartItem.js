      ...
      <div className="flex-1 flex flex-col gap-y-1">
        ...
        <div className="flex flex-col gap-y-1">
          ...
          <div className="flex items-center gap-x-1">
            {/* decrese quantity */}
            <div onClick={() => decreaseAmount(pizza.id, pizza.price)} className='w-[18px] h-[18px] flex items-center justify-center cursor-pointer text-white gradient rounded-full'>
              <BiMinus />
            </div>
            {/* pizza amount */}
            <div className="font-semibold flex flex-1 max-w-[30px] justify-center items-center text-sm">{pizza.amount}</div>
            {/* increase quantity */}
            <div onClick={() => increaseAmount(pizza.id, pizza.price)} className='w-[18px] h-[18px] flex items-center justify-center cursor-pointer text-white gradient rounded-full'>
              <BiPlus />
            </div>
          </div>
        </div>
